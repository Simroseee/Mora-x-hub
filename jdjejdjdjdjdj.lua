...
local Update = loadstring(Game:HttpGet"https://roblox.relzscript.xyz/source/morahub/library/pc.lua")()
local Alert = loadstring(Game:HttpGet"https://roblox.relzscript.xyz/source/morahub/library/alert.lua")()
local Library = Update:Window("Blox Fruits")
local Main = Library:Tab("Trang chủ","rbxassetid://17583471005")
local Set = Library:Tab("cài đặc","rbxassetid://17583471005")
local Hold = Library:Tab("Hold Skill","rbxassetid://17583471005")
local M = Library:Tab("lấy Items","rbxassetid://17583471005")
local Sea = Library:Tab("Sea123","rbxassetid://17583471005")
local Ss = Library:Tab("chỉ số","rbxassetid://17583471005")
local RaceV4 = Library:Tab("tộc","rbxassetid://17583471005")
local P = Library:Tab("Đánh lộn","rbxassetid://17583471005")
local R = Library:Tab("đi thức tính","rbxassetid://17583471005")
local ESP = Library:Tab("Esp tùm lum","rbxassetid://17583471005")
local T = Library:Tab("Di chuyển","rbxassetid://17583471005")
local S = Library:Tab("Mua gì đây","")
local D = Library:Tab("trái ác quỷ","")
local Misc = Library:Tab("ai biết","")
local Serv = Library:Tab("tào lao","rbxassetid://17583471005")
...
Main:Dropdown("Chọn vũ khí",WeaponList,_G.SelectWeapon,function(value)
...
local Bring = {"như sịt", "cũng ngon", "lag ỉa"}
_G.BringMode = "cũng ngon"
...
spawn(function()
    while wait(.1) do
        if _G.BringMode then
            pcall(function()
                if _G.BringMode == "như sịt" then
                    _G.BringMode = 350
                elseif _G.BringMode == "cũng đc" then
                    _G.BringMode = 500
                elseif _G.BringMode == "lag ỉa" then
                    _G.BringMode = 800
                end
            end)
        end
...
local AttackList = {0, 0.1 , 0.10 , 0.100, 0.150, 0.165, 0.175, 0.200, 0.250}
...
Set:Toggle("ko hiện dame",true, "Invisible Damage Text",function(Remo)
...
Set:Toggle("màn hình đen",false,false,function(Umm)
...
if World1 or World2 then
    ...
    if World1 then
        M:Toggle("Auto Sea 2",_G.AutoSecondSea,false,function(value)
...
if World1 or World2 then
RaceV4:Label("Qua sea 3")
end

if World3 then
    RaceV4:Seperator("Race V2")

    RaceV4:Toggle("Auto lên tộc [ V2 ]",_G.Auto_EvoRace,false,function(value)
...
spawn(
    ...
    S:Toggle("Auto mua haki màu",_G.AutoBuyEnchancementColour,"Auto Buy Haki Color",function(value)
...
S:Button("Random Race [ Use Æ’3000 ]", function()
    ...
    D:Toggle("Auto cất trái vào kho",_G.AutoStoreFruit,"Store Fruit",function(value)
    ...
    D:Toggle("Thông báo fruit",_G.Grabfruit,"Add Notification When Fruit Spawn",function(value)
    _G.FruitCheck = value
    end)
    ...
    D:Button("lụm hết Fruits", function()
        for i,v in pairs(game.Workspace:GetChildren()) do
            if v:IsA("Tool") then
    ...
    D:Seperator("Tào lao à")
    
    D:Button("mưa Fruit fake", function()
            for h, i in pairs(game:GetObjects("rbxassetid://17583471005")[1]:GetChildren()) do
    ...
    Misc:Button("mở shop trái ác quỷ",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)

    Misc:Button("Mở haki màu", function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
    end)

    Misc:Button("Mở Title", function()
        local args = {
            [1] = "getTitles"
        }
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    Misc:Button("nhập hết Code",function()
    ...
    Misc:Button("tăg fps ai biết",function()
...
Misc:Button("xóa sương mù",function()
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
	game.Lighting.FogEnd = 9e9
end)

Misc:Button("xóa Lava lồn",function()
...
ESP:Seperator("ESP")
    ...
    ESP:Toggle("ESP người chs",false, "Highlight Player",function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
    ESP:Toggle("ESP rương",false,"Highlight Chest",function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    ESP:Toggle("ESP trái ác quỷ",false, "Highlight Fruit",function(a)
        DevilFruitESP = a
    ...
    ESP:Toggle("ESP trái cây sea 3",false,"Highlight Real Fruit",function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    ESP:Toggle("ESP hoa ",false,"Highlight Flower",function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
ESP:Toggle("ESP đảo",IslandESP,"Highlight Island",function(value)
        IslandESP = value
...
ESP:Toggle("Esp Gear", false,"Highlight Gear", function(value)
    ...
    Misc:Toggle("Infinite Energy fake",false,false,function(value)
    ...
    Misc:Toggle("Infinite Geppo fake",getgenv().InfGeppo,false,function(value)
    ...
    Misc:Toggle("Infinite Soru fake",getgenv().InfSoru,false,function(value)
    ...
    Misc:Toggle("đi trên nước",true,false,function(value)
        _G.WalkWater = value
    end)
    ...
    Misc:Toggle("xuyên tường",_G.NoClip,false,function(value)
        _G.NoClip = value
    end)
            ...
            while wait(5) do
                pcall(function()
                        ...
                        if game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1") then
                            HakiDealer:Set(ông bán hski Spawning')
                        else
                            HakiDealer:Set('ðŸ”´ ông  bán haki ko Spawn') 
                        end
                end)
            end
        end)
    ...
    Serv:Button("vào lại svv",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Serv:Button("tìm svv khác",function()
        while wait() do
